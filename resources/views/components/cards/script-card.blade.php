...
<article class="rounded-2xl border-2 border-[#303030] bg-[#202020]">
<div class="p-8">
    ...
    <div class="flex justify-between items-start">
        ...
        <div class="flex"> 
            ...
            {{-- <div class="flex items-center bg-pink-600 rounded-xl px-4 py-2">
                ...
                <span class="text-[#c6c6c6] font-semibold block ml-1">Save</span>
            </div>
            <div class="flex items-center bg-pink-600 rounded-xl px-4 py-2 ml-2">
                <svg class="w-4 h-4 fill-white" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" role="img" class="icon "><path d="m18.199 2.04c-2.606-.284-4.262.961-6.199 3.008-2.045-2.047-3.593-3.292-6.199-3.008-3.544.388-6.321 4.43-5.718 7.96.966 5.659 5.944 9 11.917 12 5.973-3 10.951-6.341 11.917-12 .603-3.53-2.174-7.572-5.718-7.96z"></path></svg>
                <span class="text-[#c6c6c6] font-semibold block ml-1">Like</span>
            </div> --}}
        </div>
    ...
    <footer class="">
        {{-- <div class="mb-4">
            <span class="px-3 py-0.5 text-[#c6c6c6] text-xs font-semibold leading-5 uppercase tracking-wide bg-pink-500 rounded-full">Drifting</span>
            <span class="px-3 py-0.5 text-[#c6c6c6] text-xs font-semibold leading-5 uppercase tracking-wide bg-pink-500 rounded-full">Weapons</span>
            <span class="px-3 py-0.5 text-[#c6c6c6] text-xs font-semibold leading-5 uppercase tracking-wide bg-pink-500 rounded-full">Pedestrians</span>
            <span class="px-3 py-0.5 text-[#c6c6c6] text-xs font-semibold leading-5 uppercase tracking-wide bg-pink-500 rounded-full">Army</span>    
        </div> --}}
        ...
        <div class="flex justify-between items-center">
            ...
            {{-- <div class="flex"> 
                ...
                <span class="text-[#c6c6c6] block">4.8</span>
            </div>
             --}}
        </div>
